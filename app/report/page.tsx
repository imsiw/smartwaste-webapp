...
function getGeo() {
  ...
  async function submitReport() {
    ...
    try {
      ...
      console.log("CLIENT TG OBJECT:", (window as any).Telegram?.WebApp);
      console.log("CLIENT TG INIT DATA:", (window as any).Telegram?.WebApp?.initData);
      console.log("CLIENT TG USER:", (window as any).Telegram?.WebApp?.initDataUnsafe?.user);
